$(function () {
  ...
  $('.blog__buttons-tag').on('click', function () {
    $('.blog__buttons-tag').removeClass('blog__buttons-tag--active')
    $(this).addClass('blog__buttons-tag--active')
  })
  const swiper = new Swiper('.swiper', {
    slidesPerView: 2,
    loop: true,
    navigation: {
      nextEl: '.swiper__arrowright',
      prevEl: '.swiper__arrowleft',
    },
    pagination: {
